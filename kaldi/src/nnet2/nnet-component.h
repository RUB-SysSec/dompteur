...
class WindowComponent: public Component {
 public:
  void Init(int32 input_dim, int32 type);
  explicit WindowComponent(int32 input_dim, int32 type) {
    Init(input_dim, type);
  }
  WindowComponent(): input_dim_(0) { }
  virtual std::string Type() const { return "WindowComponent"; }
  virtual void InitFromString(std::string args);
  virtual int32 InputDim() const { return input_dim_; }
  ...
  virtual bool BackpropNeedsInput() const { return true; }
  virtual bool BackpropNeedsOutput() const { return true; }
  virtual Component* Copy() const { return new WindowComponent(input_dim_, type_); }
...
class FilterComponent: public Component {
 public:
  void Init(int32 input_dim, int32 start_idx, int32 end_idx);
  explicit FilterComponent(int32 input_dim, int32 start_idx, int32 end_idx) {
    Init(input_dim, start_idx, end_idx);
  }
  FilterComponent(): input_dim_(0) { }
  virtual std::string Type() const { return "FilterComponent"; }
  virtual void InitFromString(std::string args);
  virtual int32 InputDim() const { return input_dim_; }
  virtual int32 OutputDim() const { return end_idx_ - start_idx_ + 1; }
  using Component::Propagate; // to avoid name hiding
  virtual void Propagate(const ChunkInfo &in_info,
                         const ChunkInfo &out_info,
                         const CuMatrixBase<BaseFloat> &in,
  ...
  virtual bool BackpropNeedsInput() const { return true; }
  virtual bool BackpropNeedsOutput() const { return true; }
  virtual Component* Copy() const { return new FilterComponent(input_dim_, start_idx_, end_idx_); }
  virtual void Read(std::istream &is, bool binary); // This Read function
  // requires that the Component has the correct type.
  /// Write component to stream
  virtual void Write(std::ostream &os, bool binary) const;
...
class LogComponent: public Component {
 public:
  ...
  explicit LogComponent(int32 input_dim) {
    Init(input_dim);
  }
  LogComponent(): input_dim_(0) { }
  ...
  virtual bool BackpropNeedsInput() const { return true; }
  virtual bool BackpropNeedsOutput() const { return true; }
  virtual Component* Copy() const { return new LogComponent(input_dim_); }
...
class PytorchComponent: public Component {
 public:
  void Init(int32 input_dim);
  explicit PytorchComponent(int32 input_dim) {
    Init(input_dim);
  }
  PytorchComponent(): input_dim_(0) { }
  virtual std::string Type() const { return "PytorchComponent"; }
  virtual void InitFromString(std::string args);
  virtual int32 InputDim() const { return input_dim_; }
  virtual int32 OutputDim() const { return input_dim_; }
  using Component::Propagate; // to avoid name hiding
  ...
  virtual bool BackpropNeedsInput() const { return true; }
  virtual bool BackpropNeedsOutput() const { return true; }
  virtual Component* Copy() const { return new PytorchComponent(input_dim_); }
...
class AbsComponent: public Component {
 public:
  void Init(int32 input_dim);
  explicit AbsComponent(int32 input_dim) {
    Init(input_dim);
  }
  AbsComponent(): input_dim_(0) { }
  virtual std::string Type() const { return "AbsComponent"; }
  virtual void InitFromString(std::string args);
  virtual int32 InputDim() const { return input_dim_; }
  virtual int32 OutputDim() const { return input_dim_/2; }
  using Component::Propagate; // to avoid name hiding
  virtual void Propagate(const ChunkInfo &in_info,
                         const ChunkInfo &out_info,
                         const CuMatrixBase<BaseFloat> &in,
  ...
  virtual bool BackpropNeedsInput() const { return true; }
  virtual bool BackpropNeedsOutput() const { return true; }
  virtual Component* Copy() const { return new AbsComponent(input_dim_); }
...
class ConvRIRComponent: public Component {
 public:
  ConvRIRComponent() { }  // called only prior to Read() or Init().
  // input dim frame len-overlap, e.g 512, 256
  void Init(int32 input_dim,
            CuMatrix<BaseFloat> filter_params);
  virtual std::string Type() const { return "ConvRIRComponent"; }
  virtual std::string Info() const;
  virtual void InitFromString(std::string args);
  virtual int32 InputDim() const { return input_dim_; }
  ...
  virtual void Write(std::ostream &os, bool binary) const;
 private:
  KALDI_DISALLOW_COPY_AND_ASSIGN(ConvRIRComponent);
  int32 input_dim_;
  CuMatrix<BaseFloat> filter_params_;
  CuMatrix<BaseFloat> invers_filter_params_;
};

class OverlapComponent: public Component {
 public:
  OverlapComponent() { }  // called only prior to Read() or Init().
  // input dim frame len-overlap, e.g 512 - 256
  void Init(int32 input_dim,
            int32 overlap);
  virtual std::string Type() const { return "OverlapComponent"; }
  virtual std::string Info() const;
  virtual void InitFromString(std::string args);
  virtual int32 InputDim() const { return input_dim_; }
  virtual int32 OutputDim() const;
  ...
  virtual void Write(std::ostream &os, bool binary) const;
 private:
  KALDI_DISALLOW_COPY_AND_ASSIGN(OverlapComponent);
  int32 input_dim_;
  int32 overlap_;
};
...
class FftComponent: public Component {
 public:
  FftComponent() { dim_ = 0; }
  virtual std::string Type() const { return "FftComponent"; }
  virtual std::string Info() const;
  //dim = dimension of vector being processed
  //fft_dim = effective lenght of FFT, i.e. how many compoments will be kept
  void Init(int32 dim, int32 fft_dim, bool reorder, int32 keep_fft_dim=0);
  // InitFromString takes numeric options
  // dim, fft-dim, and (optionally) reorder={true,false}, keep-fft-dim
  // Note: reorder defaults to false. keep-fft-dim defaults to fft-dim
  virtual void InitFromString(std::string args);
  virtual int32 InputDim() const { return dim_; }
  virtual int32 OutputDim() const { return fft_mat_.NumRows() * (dim_ / fft_mat_.NumCols()); }
  using Component::Propagate; // to avoid name hiding
  virtual void Propagate(const ChunkInfo &in_info,
                         const ChunkInfo &out_info,
                         const CuMatrixBase<BaseFloat> &in,
 ...
 private:
  ...
  CuMatrix<BaseFloat> fft_mat_;

  KALDI_DISALLOW_COPY_AND_ASSIGN(FftComponent);
};
